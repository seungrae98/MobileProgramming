...
fun LogInScreen(
    ...
    var userPw = remember { mutableStateOf("") }
    var loginError by remember { mutableStateOf(false) }

    var loginResult = userDataViewModel.checkInfo(userID.value, userPw.value)
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        OutlinedTextField(value = userID.value,
            onValueChange = {userID.value =it},
            label = {Text("아이디")}
        )

        OutlinedTextField( value = userPw.value,
            onValueChange = { userPw.value = it },
            label = { Text("비밀번호") },
